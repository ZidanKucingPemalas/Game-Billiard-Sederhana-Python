...
# asset gambar
cue_image = pygame.image.load("f:\Game Billiard Sederhana Python\Asset Game Billiard Python\Asset Game New\cue 2.png").convert_alpha()
table_image = pygame.image.load("f:\Game Billiard Sederhana Python\Asset Game Billiard Python\Asset Game New/table 2.png").convert_alpha()
ball_images = []
for i in range(1, 17):
    ball_image = pygame.image.load(f"f:\Game Billiard Sederhana Python\Asset Game Billiard Python\Asset Game New/ball_{i}.png").convert_alpha()
...
hit_sound = pygame.mixer.Sound("f:\Game Billiard Sederhana Python\Asset Game Billiard Python\Music dan Sound Effect/billiards+2.wav")
...
while run:
    ...
    draw_text("NYAWA: " + str(lives), font, WHITE, SCREEN_WIDTH - 150, SCREEN_HEIGHT + 10)
